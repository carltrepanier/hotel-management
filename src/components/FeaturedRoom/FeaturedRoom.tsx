				...
				<div className='flex flex-col md:flex-row md:items-end justify-between mt-5'>
					<div className='flex mb-3 md:mb-0'>
						<div className='flex flex-col gap-3 items-center justify-center mr-4'>
							<p className='text-xs md:text-xl text center'>Start From</p>
							<p className='flex md:font-bold font-medium text-lg xl:text-5xl'>
								{featuredRoom.price}$
							</p>
						</div>

						<div className='flex flex-col gap-3 items-center justify-center mr-4'>
							<p className='text-xs md:text-xl text center'>Discount</p>
							<p className='flex md:font-bold font-medium text-lg xl:text-5xl'>
					...
					<Link
						...
						className='border h-fit text-center border-tertiary-dark text-tertiary-dark px-3 py-2 md:py-5 md:px-7 rounded-2xl font-bold md:text-xl'
					>
						More Details
					</Link>
				</div>
